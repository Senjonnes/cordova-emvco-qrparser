...
import Model.EMVCoQRParserModel;
 ...
 */
public class EMVCoQRParserPlugin {
    ...
    public EMVCoQRParserPlugin(String emvcoQrValue, int tag) {
        this.emvcoQrValue = emvcoQrValue;
        this.tag = tag;
    }

    public EMVCoQRParserPlugin(String emvcoQrValue, int tag, int subTag) {
        this.emvcoQrValue = emvcoQrValue;
        this.tag = tag;
        this.subTag = subTag;
        hasSubTag = true;
    ...
    public String getParsingValue() {
        Map<Integer, EMVCoQRParserModel> parsingValues = parseEmvcoQR(emvcoQrValue);
        EMVCoQRParserModel obj = parsingValues.get(tag);
        if (hasSubTag) {
    ...
    private Map<Integer, EMVCoQRParserModel> parseEmvcoQR(String str) {
        Map <Integer, EMVCoQRParserModel> result = new HashMap<Integer, EMVCoQRParserModel>();
        int i = 0;
        ...
        while (i < str.length()) {
            ...
            EMVCoQRParserModel emvObject = new EMVCoQRParserModel();
